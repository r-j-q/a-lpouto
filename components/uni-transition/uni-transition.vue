...
<script>
	...
	// 	import uniSwiper from '@/components/mswiper';
	// 	import uniPush from '@/components/mpush';
	...
	// 					that.playerCur = res.data;
	// 					that.dangqian = res.data;
	// 				}
	// 			});
	// 			uni.$on('playid', event => {
	// 				console.log(event);
	...
	// 				type: e.type
	// 			})
	// 			uni.$emit('zhuyelaiyuan', {
	// 				zhuyelaiyuan: e.zhuyelaiyuan
	// 			})
	// 		},
	// 		onShow() {
	// 			uni.hideTabBar()
